...
public final class Parameters {
    ...
    public static final float MAXIMUM_SIZE = WIDTH / 20f;
    public static final float MINIMUM_SIZE = MAXIMUM_SIZE / 10;
    public static final int NUMBER_OF_CIRCLES = 100;
    public static final int NUMBER_OF_ITERATIONS = 2500;
    public static final float CIRCLE_INITIAL_RADIUS = WIDTH / 4f;
    public static final float CIRCLE_MINIMUM_SPEED = .5f;
    public static final float CIRCLE_MAXIMUM_SPEED = 3f;
    public static final Color BACKGROUND_COLOR = new Color(255);
    public static final Color STROKE_COLOR = new Color(30, 25, 15, 5.1f);
